...
import { View, Text, ScrollView, TextInput, ActivityIndicator, Alert, Linking, TouchableOpacity, SafeAreaView } from 'react-native'
  ...
  render() {
    return (
      <SafeAreaView style={{ flex: 1 }}>
        <SimpleHeader goBack navigation={this.props.navigation} title='Reset Password' />
        <ScrollView>
          <View style={{ paddingHorizontal: 20, marginTop: 15 }}>
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: Color.borderColor }}>
                <TextInput
                  ...
                  placeholder='ekomardiatno@domain.com' placeholderTextColor={Color.gray} keyboardType='email-address' autoCapitalize='none' style={{ paddingHorizontal: 0, paddingVertical: 6, flex: 1, fontFamily: 'Yantramanav', letterSpacing: 1, color: Color.black }} />
            ...
            {
              this.state.loading ?
              <View style={{ backgroundColor: Color.blue, elevation: 3, borderRadius: 3, alignItems: 'center', justifyContent: 'center', height: 40 }}>
