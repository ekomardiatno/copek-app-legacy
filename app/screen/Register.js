...
import { View, Text, ScrollView, TextInput, TouchableOpacity, ActivityIndicator, Alert, Linking, SafeAreaView } from 'react-native'
...
export default class Register extends Component {
  ...
  _onRegister = () => {
    ...
    if (name !== '' && phone !== '' && email !== '' && reg.test(this.state.email) && pass !== '' && pass.length >= 8 && pass === repass) {
      const data = {
        userName: name,
        userPhone: phone,
        userEmail: email,
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
          ...
          <View style={{ paddingHorizontal: 20, paddingTop: 20, marginBottom: 15 }}>
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: Color.borderColor }}>
                <TextInput placeholderTextColor={Color.gray} value={this.state.name} onChangeText={text => this.setState({ name: text })} placeholder='Eko Mardiatno' autoCapitalize='words' style={{ paddingHorizontal: 0, paddingVertical: 6, flex: 1, fontFamily: 'Yantramanav', color: Color.black, letterSpacing: 1 }} />
                <View style={{ width: 40, alignItems: 'center', justifyContent: 'center' }}>
                  <Icon iconStyle='solid' color={Color.gray} name='user-alt' size={20} />
                </View>
              </View>
            </View>
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: Color.borderColor }}>
                ...
                <TextInput placeholderTextColor={Color.gray} value={this.state.phone} onChangeText={text => this.setState({ phone: text })} placeholder='81234567890' keyboardType='number-pad' style={{ paddingHorizontal: 0, paddingVertical: 6, flex: 1, fontFamily: 'Yantramanav', color: Color.black, letterSpacing: 1 }} />
                <View style={{ width: 40, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: Color.borderColor }}>
                <TextInput placeholderTextColor={Color.gray} autoCapitalize='none' value={this.state.pass} onChangeText={text => this.setState({ pass: text })} placeholder='••••••••' secureTextEntry={true} style={{ paddingHorizontal: 0, paddingVertical: 6, flex: 1, fontFamily: 'Yantramanav', color: Color.black, letterSpacing: 5 }} />
                <View style={{ width: 40, alignItems: 'center', justifyContent: 'center' }}>
                  <Icon iconStyle='solid' color={Color.gray} name='key' size={20} />
                </View>
              </View>
            </View>
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: Color.borderColor }}>
                <TextInput placeholderTextColor={Color.gray} autoCapitalize='none' value={this.state.repass} onChangeText={text => this.setState({ repass: text })} placeholder='••••••••' secureTextEntry={true} style={{ paddingHorizontal: 0, paddingVertical: 6, flex: 1, fontFamily: 'Yantramanav', color: Color.black, letterSpacing: 5 }} />
                <View style={{ width: 40, alignItems: 'center', justifyContent: 'center' }}>
                  <Icon iconStyle='solid' color={Color.gray} name='key' size={20} />
                </View>
              </View>
            ...
            {
              this.state.loading ?
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: Color.blue, height: 40, elevation: 3, borderRadius: 3 }}>
            ...
            <View style={{ paddingHorizontal: 30, marginVertical: 15 }}>
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => Linking.openURL('whatsapp://send?phone=+6287888161111')}
              >
        ...
        <View style={{ paddingHorizontal: 20, paddingVertical: 10, borderTopWidth: 1, borderTopColor: Color.green, alignItems: 'center', elevation: 10, backgroundColor: Color.green }}>
          ...
          >
            <View style={{ flexDirection: 'row' }}>
              <Text style={{ fontSize: 13, color: colorYiq(Color.green) }}>Sudah punya akun? </Text>
              <Text style={{ fontWeight: 'bold', fontSize: 13, color: colorYiq(Color.green) }}>Masuk.</Text>
            </View>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
